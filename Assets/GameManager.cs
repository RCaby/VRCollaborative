...
namespace WasaaMP {
    public class GameManager : MonoBehaviourPunCallbacks {
        ...
        [Tooltip("The prefab to use for representing the cursor")]
        public CursorTool cursorPrefab;
        ...
        void Start () {
            ...
            if (playerPrefab == null) {
                ...
                if (Navigation.LocalPlayerInstance == null) {
                    ...
                    PhotonNetwork.Instantiate(this.cursorPrefab.name, new Vector3(0,0,0), Quaternion.identity, 0);
                } else {
